                                        ...
                                        <div class="col-md-12 col-sm-12">
                                            ...
                                            if (isset($_POST['sub'])) {
                                                ...
                                                $data = array(
                                                    ...
                                                    "ap_date" => $d->VD($_POST['ap_date']),
                                                    "slot" => $d->VD($_POST['slot']),
                                                );
                                                //print_r($data);

                                                if ($d->insert("apointment", $data)) {
                                                    Redirect("index.php?f=view-appoinment");
                                                } else {
                                                    echo $d->Error;
                                                }
                                            }
                                            ...
                                            <form class="appointment-form" method="post">                
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-12">
                                                        ...
                                                        <select name="deptid" class="wp-form-control wpcf7-select">
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        ...
                                                        <input class="form-control wp-form-control wpcf7-select" type='text' name='ap_date' id='datepicker' />                    </div>
                                                ...
                                                <button name="sub" class="wpcf7-submit button--itzel" type="submit"><i class="button__icon fa fa-share"></i><span>Book Appointment</span></button>  
                                            </form>
                                        </div>
