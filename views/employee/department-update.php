        ...
        <div class="row">
            <div class="col-lg-7 col-md-7 col-sm-6">
                <div class="contact-form">
                    ...
                    $d = new Database();
                    if (isset($_GET['id'])) {
                        $data = $d->view("department", '*', '', ['id' => $_GET['id']]);
...
//                    echo $date;} //gives date as 2012-08-17
                    ...
                    if (isset($_POST['sub'])) {
                        ...
                        // print_r($data);
                        //die();
                        if ($d->update("department", $data, array("id" => $_GET['id']))) {
                    ...
                    <form class="submitphoto_form" action="#" method="post">
                        ...
                        <input type="text" name="name" class="wp-form-control wpcf7-text" value="<?php if (isset($_GET['id'])) echo $value->name ?>" placeholder="Name">
