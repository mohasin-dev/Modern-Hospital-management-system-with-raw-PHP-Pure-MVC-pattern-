        ...
        <div class="row">
            <div class="col-lg-7 col-md-7 col-sm-6">
                <div class="contact-form">
                    ...
                    $d = new Database();
                    if (isset($_GET['id'])) {
                        $data =$d->view("customer", "", "", ["id" => $_GET['id']]);
...
//                    echo $date;} //gives date as 2012-08-17
                    ...
                    if (isset($_POST['sub'])) {
                        ...
                        // print_r($data);
                        //die();
                        if ($d->update("customer", $data, array("id" => $_GET['id']))) {
                            echo "Update Successfull";
                            redirect("index.php?d=customer-views");
                        } else {
                            echo $d->Error;
                        }
                    }
                    ?>
                    <a href="index.php?d=customer" class="btn btn-active">Insert</a>
                    <a href="index.php?d=customer-views" class="btn btn-info">View</a>
