...
<section id="blogArchive">
    <div class="container">
        <div class="col-md-12">
            ...
            <a href="index.php?e=admission" class="btn btn-info">New Admission</a>
            <a href="index.php?e=admission_view" class="btn btn-info">Admission's Informations View</a>
            <a href="index.php?e=admission_not_release" class="btn btn-info">Unreleased Patient</a>
            ...
            <table class="table table-striped table-hover" border="1px" style="border: 1px solid #970001">
                ...
                while ($value = $data->fetch_object()) {
                    ...
                    if ($value->releasedate != '') {
                        echo "<td><a  class='btn btn-info'>Relesed</a></td>";
                    } else {
                        echo "<td><a href='index.php?e=release_receipt&id={$value->id}' class='btn btn-info'>Relese</a></td>";
                    }
